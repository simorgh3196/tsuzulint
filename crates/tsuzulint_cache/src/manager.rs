...
mod tests_extra {
    ...
    fn test_load_cache_at_exact_max_size() {
        ...
        // The content won't parse as valid rkyv. Some rkyv configurations might successfully parse empty entries or crash on zeros.
        // We don't care about the exact error, only that it is NOT a "exceeds maximum size" error.
