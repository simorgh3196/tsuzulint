...
mod tests {
    ...
    #[ignore = "TODO: Requires proper Extism-compatible WASM module; raw WAT with Extism ABI is complex"]
    fn test_run_all_rules() {
        // This test requires a WASM module compiled with Extism PDK.
        // Creating a compatible module in raw WAT that properly uses Extism's
        // input/output conventions is complex. See Extism PDK documentation.
        // For now, run_all_rules is tested indirectly through integration tests.
    }
}
